...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/flight_details" method="post" class="mb-3">
        <div class="form-row">
            <div class="col-md-3">
                <input type="hidden" name="id" value="${flight.id}">
                <input type="hidden" name="action" value="update">
                <input type="text" name="source" class="form-control" placeholder="Source" value="${flight.getSource()}" required> <br>
                <input type="text" name="destination" class="form-control" placeholder="Destination" value="${flight.getDestination()}" required> <br>
                <input type="datetime-local" name="departureTime" class="form-control" value="${flight.getDepartureTime()}" required> <br>
                <input type="datetime-local" name="arrivalTime" class="form-control" value="${flight.getArrivalTime()}" required> <br>
        ...
        <br>
        <button type="submit" class="btn btn-primary mt-2">Update Flight</button>
    </form>

    <form action="${pageContext.request.contextPath}/flight_details" method="post">
        <input type="hidden" name="id" value="${flight.id}">
        <input type="hidden" name="action" value="delete">
        <button class="btn btn-danger mt-2" type="submit">Delete Flight</button>
    </form>
