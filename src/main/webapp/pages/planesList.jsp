...
<div class="container">
    ...
    <form action="" method="post" class="mb-3">
        <div class="form-row">
            <div class="col-md-3">
                <input type="text" name="manufacturer" class="form-control" placeholder="Manufacturer" required> <br>
        ...
        <br>
        <button type="submit" class="btn btn-primary mt-2">Create Plane</button>
    </form>
